...
export default function Header(){
    ...
    return(
      ...
      >
        ...
        <a href="/" className="text-lg hover:underline">Página Inicial</a>
          <a href="/cartas" className="text-lg hover:underline">Cartas</a>
          <a href="/linha-tempo" className="text-lg hover:underline">Linha do Tempo</a>
          <a href="/playlist" className="text-lg hover:underline">PlayList</a>
          <a href="/quiz" className="text-lg hover:underline">Quiz</a>
        </nav>
      </motion.div>
        </div>
    )
